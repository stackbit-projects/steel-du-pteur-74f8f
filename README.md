...
1. Run the following command to fetch the content from Sanity:
        ...
        npx @stackbit/stackbit-pull --stackbit-pull-api-url=https://api.stackbit.com/pull/60774f8fba96040016c1d04c
...
To start editing your site, you can use the Sanity interface at https://steel-du-pteur-74f8f.sanity.studio/.
...
Generated at `2021-04-14T20:27:18.081Z` by Stackbit version `0.3.50`.